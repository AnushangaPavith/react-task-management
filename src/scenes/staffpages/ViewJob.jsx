...
function ViewJob() {
  ...
  const fieldNames = {
    ...
    staffPayTotal: "Total Payment",
    estNoOfhours: "Estimated Number of Hours",
    staffHourRate: "Hour Rate",
    staffExtraHours: "Extra Hours",
    staffExtraPayment: "Extra Payment",
  ...
  const fetchJobDetails = async () => {
    try {
      ...
      if (responseData.success) {
        ...
        const { jobName, description, client, assignedStaff, orgNoOfhours, orgHourRate, orgTotal, estNoOfhours, staffHourRate, staffExtraHours, staffExtraPayment, staffPayTotal, jobStatus, notes ,jobDate, signInTime,
          signOffTime,} = job;
